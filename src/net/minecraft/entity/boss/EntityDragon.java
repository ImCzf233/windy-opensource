...
public class EntityDragon extends EntityLiving implements IBossDisplayData, IEntityMultiPart, IMob
{
    ...
    /**
     * Activated if the dragon is flying though obsidian, white stone or bedrock. Slows move and animation speed.
     */
    ...
    /**
     * Returns a double[3] array with move offsets, used to calculate trailing tail/neck positions. [0] = yaw
