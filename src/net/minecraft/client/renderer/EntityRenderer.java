...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public void func_181560_a(float p_181560_1_, long p_181560_2_)
    {
        ...
        if (!this.mc.skipRenderWorld)
        {
            ...
            final ScaledResolution scaledresolution = new ScaledResolution(this.mc, Minecraft.getMinecraft().displayWidth, Minecraft.getMinecraft().displayHeight);
            ...
            if (this.mc.currentScreen != null)
            {
                ...
                catch (Throwable throwable)
                {
                    ...
                    CrashReportCategory crashreportcategory = crashreport.makeCategory("Screen vision details");
    ...
    {
        this.setupOverlayRendering();
        this.mc.ingameGUI.renderStreamIndicator(new ScaledResolution(this.mc, Minecraft.getMinecraft().displayWidth, Minecraft.getMinecraft().displayHeight));
    }
