...
public class WorldRenderer
{
    ...
    public void putColorMultiplier(float red, float green, float blue, int p_178978_4_)
    {
        ...
        if (!this.needsUpdate)
        {
            ...
            if (ByteOrder.nativeOrder() == ByteOrder.LITTLE_ENDIAN)
            {
                ...
                j &= Client.instance.getModuleManager().getModuleByClass(Xray.class).isEnabled() ? 1073741824 : -16777216;
                j = j | i1 << 16 | l << 8 | k;
            }
            else
            {
	...
	public void addVertex(double right, double top, double d) {
		// TODO �Զ����ɵķ������
		
	}

	public void addVertexWithUV(double x, double par2, double d, double e, double f) {
		// TODO �Զ����ɵķ������
