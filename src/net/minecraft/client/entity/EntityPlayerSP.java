...
import space.emptiness.module.modules.move.NoSlow;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    /**
     * called every tick when the player is on foot. Performs all the things that normally happen during move.
     */
    ...
    public void setItemUseCount(int x){
        this.itemInUseCount = x;
    }
    ...
    public void onLivingUpdate()
    {
        ...
        boolean noslow = Client.getModuleManager().getModuleByClass(NoSlow.class).isEnabled();
