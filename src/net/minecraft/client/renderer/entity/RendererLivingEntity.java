...
import space.emptiness.module.modules.visual.Chams;
import space.emptiness.module.modules.visual.ESP;
import space.emptiness.module.modules.visual.Nametags;
import space.emptiness.utils.Helper;
import space.emptiness.utils.render.OutlineUtils;
...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T>
{
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        if (!Reflector.RenderLivingEvent_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, new Object[] {entity, this, Double.valueOf(x), Double.valueOf(y), Double.valueOf(z)}))
        {
            ...
            {
                logger.error((String)"Couldn\'t vision entity", (Throwable)exception);
            }
    ...
    protected void renderModel(T entitylivingbaseIn, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float p_77036_7_)
    {
        ...
        if (flag || flag1)
        {
            ...
            if ((chams = (Chams)Client.instance.getModuleManager().getModuleByClass(Chams.class)).isEnabled() && chams.mode.getValue() == Chams.ChamsMode.Textured && entitylivingbaseIn instanceof EntityPlayer) {
                ...
                GL11.glColor3d((double)(!Helper.mc.thePlayer.canEntityBeSeen(entitylivingbaseIn) ? 1.0 : 0.0), (double)(!Helper.mc.thePlayer.canEntityBeSeen(entitylivingbaseIn) ? 0.5 : 1.0), (double)(!Helper.mc.thePlayer.canEntityBeSeen(entitylivingbaseIn) ? 0.0 : 0.0));
            ...
            if (!chams.isEnabled() || chams.mode.getValue() != Chams.ChamsMode.Textured) {
            	this.mainModel.render(entitylivingbaseIn, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, p_77036_7_);
            }	
    ...
    /**
     * Allows the vision to do any OpenGL state modifications necessary before the model is rendered. Args:
