...
public class NetworkManager extends SimpleChannelInboundHandler<Packet>
{
    ...
    {
        EventPacketReceive packetRecieve = new EventPacketReceive((Packet)p_channelRead0_2_);
        EventManager.call(packetRecieve);
        final EventPacket packetEvent = new EventPacket(p_channelRead0_2_, false);
    ...
    public void sendPacket(Packet packetIn) {
        final EventPacket event = new EventPacket(packetIn, true);
        ...
        if (this.isChannelOpen()) {
            ...
            try {
                this.outboundPacketsQueue.add(new NetworkManager.InboundHandlerTuplePacketListener(event.getPacket(),
