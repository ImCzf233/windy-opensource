...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void addToSendQueue(Packet p_147297_1_)
    {
        ...
        this.netManager.sendPacket(packetSent.getPacket());
    }
    ...
    {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        EventChatReceive e = new EventChatReceive(packetIn.getType(), packetIn.getChatComponent());
        EventManager.call(e);
    ...
    public void handleChangeGameState(S2BPacketChangeGameState packetIn)
    {
        ...
        else if (i == 5)
        {
            ...
            {
                this.gameController.ingameGUI.getChatGUI().printChatMessage(new ChatComponentTranslation("demo.help.move", new Object[] {GameSettings.getKeyDisplayString(gamesettings.keyBindForward.getKeyCode()), GameSettings.getKeyDisplayString(gamesettings.keyBindLeft.getKeyCode()), GameSettings.getKeyDisplayString(gamesettings.keyBindBack.getKeyCode()), GameSettings.getKeyDisplayString(gamesettings.keyBindRight.getKeyCode())}));
            }
            else if (f == 102.0F)
            {
    ...
    public void sendPacketNoEvents(Packet a2) {
        this.netManager.sendPacket(a2);
    }

    public void sendQueueWithoutEvent(final Packet p_147297_1_) {
