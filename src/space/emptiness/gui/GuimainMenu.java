...
import space.emptiness.gui.login.Alt;
import space.emptiness.gui.login.GuiAltManager;
import space.emptiness.utils.ParticleEngine;
...
import static space.emptiness.gui.login.AltManager.getAlts;
...
public class GuimainMenu extends GuiScreen implements GuiYesNoCallback{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.mc.getTextureManager().bindTexture(new ResourceLocation("windy/mainmenu/bg3.png"));
        GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
        ScaledResolution sr = new ScaledResolution(this.mc, this.mc.displayWidth, this.mc.displayHeight);
        ...
        FontLoaders.GBD30.drawString("", 1, 1, -1);
        GlStateManager.disableAlpha();
        GlStateManager.enableBlend();
        ...
        FontLoaders.GBD30.drawString(" Power by Windy Dev Group", 5, sr.getScaledHeight() - 5 - FontLoaders.GBD30.getHeight() + 1, -1);

        FontLoaders.GBD30.drawString("Minecraft 1.8.8 / Windy 1.0", sr.getScaledWidth() - 5 - 0.5f - FontLoaders.GBD30.getStringWidth("Minecraft 1.8.8 / Windy 1.0") + 1, sr.getScaledHeight() - 5 - FontLoaders.GBD30.getHeight() + 1, -1);

        CFontRenderer font1 = FontLoaders.GBD30;
        font1.drawString(Client.name + " " + Client.version, width / 2 - font1.getStringWidth(Client.name + " " + Client.version) / 2, height / 2 - font1.getHeight() / 2 + 60, new Color(253, 1, 1).getRGB());
        ...
        if(zoom1 > 1){
            ...
            GlStateManager.translate(-(offset + 32), -(height + 64), 0);
            FontLoaders.GBD30.drawString("Singleplayer", offset + 32 - FontLoaders.GBD30.getStringWidth("Singleplayer")/2 + 0.5f, height + 140/2 + 1 - 4, new Color(100/255f ,100/255f ,100/255f, Math.max(0, Math.min(1, 0.5f+(zoom1-1)*2.5f))).getRGB());
        }
        GlStateManager.popMatrix();
        ...
        if(zoom2 > 1){
            ...
            GlStateManager.translate(-(offset + 32), -(height + 64), 0);
            FontLoaders.GBD30.drawString("Multiplayer", offset + 32 - FontLoaders.GBD30.getStringWidth("Multiplayer")/2 + 0.5f, height + 140/2 + 1 - 4, new Color(100/255f ,100/255f ,100/255f, Math.max(0, Math.min(1, 0.5f+(zoom2-1)*2.5f))).getRGB());
        }
        GlStateManager.popMatrix();
        ...
        if(zoom3 > 1){
            ...
            GlStateManager.translate(-(offset + 32), -(height + 64), 0);
            FontLoaders.GBD30.drawString("Connect", offset + 32 - FontLoaders.GBD30.getStringWidth("Connect")/2 + 0.5f, height + 140/2 + 1 - 4, new Color(100/255f ,100/255f ,100/255f, Math.max(0, Math.min(1, 0.5f+(zoom3-1)*2.5f))).getRGB());
        }
        GlStateManager.popMatrix();
        ...
        if(zoom4 > 1){
            ...
            GlStateManager.translate(-(offset + 32), -(height + 64), 0);
            FontLoaders.GBD30.drawString("Settings", offset + 32 - FontLoaders.GBD30.getStringWidth("Settings")/2 + 0.5f, height + 140/2 + 1 - 4, new Color(100/255f ,100/255f ,100/255f, Math.max(0, Math.min(1, 0.5f+(zoom4-1)*2.5f))).getRGB());
        }
        GlStateManager.popMatrix();
        ...
        if(zoom5 > 1){
            ...
            GlStateManager.translate(-(offset + 32), -(height + 64), 0);
            FontLoaders.GBD30.drawString("Alt Manager", offset + 32 - FontLoaders.GBD30.getStringWidth("Alt Manager")/2 + 0.5f, height + 140/2 + 1 - 4, new Color(100/255f ,100/255f ,100/255f, Math.max(0, Math.min(1, 0.5f+(zoom5-1)*2.5f))).getRGB());
        }
        GlStateManager.popMatrix();
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException
    {
        ...
        if(mouseButton == 0){
            ...
            offset += 122/2f;
            if(this.isMouseHoveringRect1(offset + 4, height + 4, 64-8, 64-8, mouseX, mouseY)){
                for(Alt a : Client.instance.getAltManager().getAlts()){

                    Client.instance.getAltManager().selectedAlt = null;
                    a.slideTrans = 0;
