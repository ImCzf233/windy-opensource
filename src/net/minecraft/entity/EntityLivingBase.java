...
public abstract class EntityLivingBase extends Entity
{
    ...
    public int KillAuraESPAnimation;
    public boolean isUp;
    ...
    /**
     * The amount of time remaining this entity should act 'dead', i.e. have a corpse in the misc.
     */
    ...
    private int getArmSwingAnimationEnd() {
        return 6 + (int) (6 - 6 * Animations.swingspeed.getValue()) * 2;
//        return this.isPotionActive(Potion.digSpeed) ? 6 - (1 + this.getActivePotionEffect(Potion.digSpeed).getAmplifier()) * 1 : (this.isPotionActive(Potion.digSlowdown) ? 6 + (1 + this.getActivePotionEffect(Potion.digSlowdown).getAmplifier()) * 2 : 6);
    ...
    /**
     * sets the dead flag. Used when you fall off the bottom of the misc.
     */
    protected void kill()
    {
    ...
    /**
     * Returns whether the entity is in a server misc
     */
