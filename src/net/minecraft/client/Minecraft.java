...
import space.emptiness.events.misc.EventClick;
...
import space.emptiness.events.world.EventWorldLoad;
import space.emptiness.gui.GuimainMenu;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    public FontRenderer customFontRenderer;
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        this.customFontRenderer = new FontRenderer(this.gameSettings,new ResourceLocation("textures/font/ascii_custom.png"),this.renderEngine,false);
        this.mcResourceManager.registerReloadListener(this.fontRendererObj);
        this.mcResourceManager.registerReloadListener(this.standardGalacticFontRenderer);
        this.mcResourceManager.registerReloadListener(new GrassColorReloadListener());
        this.mcResourceManager.registerReloadListener(new FoliageColorReloadListener());
        this.mcResourceManager.registerReloadListener(this.customFontRenderer);
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle("Windy is loading......");
    ...
    {
        ScaledResolution scaledresolution = new ScaledResolution(this, Minecraft.getMinecraft().displayWidth, Minecraft.getMinecraft().displayHeight);
    ...
    private void runGameLoop() throws IOException
    {
        ...
        this.checkGLError("Pre vision");
        this.mcProfiler.endStartSection("sound");
        this.mcSoundHandler.setListener(this.thePlayer, this.timer.renderPartialTicks);
        this.mcProfiler.endSection();
        this.mcProfiler.startSection("vision");
    ...
    private void clickMouse()
    {
        ...
        {
            final EventClick e = new EventClick();
            EventManager.call(e);
            this.thePlayer.swingItem();
