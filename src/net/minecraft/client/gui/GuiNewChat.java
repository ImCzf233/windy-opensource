...
import space.emptiness.events.EventManager;import com.google.common.collect.Lists;
...
public class GuiNewChat extends Gui
{
                    ...
                    if (chatline != null)
                    {
                        ...
                        if (j1 < 200 || flag)
                        {
                            ...
                            if (l1 > 3)
                            {
                                ...
                                float width = mc.fontRendererObj.getStringWidth(s);
                                if (l1 == 255) {
                                    chatline.x = chatline.animationUtils.animate(width, chatline.x, 0.02f);
                                } else {
                                    chatline.x = chatline.animationUtils.animate(width, chatline.x, 0.02f);
                                }
                                ...
                                this.mc.fontRendererObj.drawStringWithShadow(s, (float)i2 + chatline.x - width, (float)(j2 - 8), new Color(255, 255, 255, (int) (chatline.x / width * 255)).getRGB());
    ...
    public void printChatMessageWithOptionalDeletion(IChatComponent p_146234_1_, int p_146234_2_)
    {
        ...
        EventChat ec = new EventChat(p_146234_1_.getUnformattedText());
