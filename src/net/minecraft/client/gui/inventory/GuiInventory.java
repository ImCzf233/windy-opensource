...
public class GuiInventory extends InventoryEffectRenderer
{
    ...
    public static void drawEntityOnScreen2(int posX, int posY, int scale, float mouseX, float mouseY, EntityLivingBase ent) {
        drawEntityOnScreen2(posX, posY, scale, mouseX, mouseY, ent, 135);
    }
    /**
     * Draws the entity to the screen. Args: xPos, yPos, scale, mouseX, mouseY, entityLiving
     */
    public static void drawEntityOnScreen2(int posX, int posY, int scale, float mouseX, float mouseY, EntityLivingBase ent, float rotate) {
